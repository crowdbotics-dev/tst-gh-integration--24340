...
## Project Structure
    ...
    ├── tst_gh_integration__24340  # Django project configurations
...
1. Clone this repo and `cd tst_gh_integration__24340`
...
2. Clone this repo and `cd tst_gh_integration__24340`
